...
<head>
  <meta charset="UTF-8">
  <title>Dashboard Moldshop | Kontrol Stok Barang</title>
...
<body>
  <!-- Sidebar -->
  <div class="sidebar">
    <h4>Moldshop Panel</h4>
    <ul>
      <li><a href="dashboard_moldshop.php">📦 Data Barang</a></li>
      <li><a href="add_item_moldshop.php">➕ Tambah Barang</a></li>
      <li><a href="history_moldshop.php">🧾 History Perubahan</a></li>
...
<?php endif; ?>
  ...
  📦 Data Stok Barang - Moldshop
  <a href="export_excel_moldshop.php" class="btn btn-success btn-sm">
    ⬇️ Export CSV
  </a>
</h2>
    <hr>
        ...
        <?php if ($result->num_rows > 0): ?>
          <?php while($row = $result->fetch_assoc()): ?>
            <tr>
              ...
              <td>
            <a href="edit_item_moldshop.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">✏️ Edit</a>
            <a href="delete_item_moldshop.php?id=<?= $row['id']; ?>"
